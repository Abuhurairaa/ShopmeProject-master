...
public class ProductController {
	...
	public String viewCategoryByPage(@PathVariable("category_alias") String alias,
		...
		long startCount = (pageNumber - 1) * ProductService.PRODUCT_PER_PAGE +1;
		long endCount = pageNumber + ProductService.PRODUCT_PER_PAGE -1;
	...
	public String searchByPage(@Param("keyword") String keyword,
		...
		long startCount = (pageNumber - 1) * ProductService.SEARCH_RESULT_PER_PAGE +1;
		long endCount = pageNumber + ProductService.SEARCH_RESULT_PER_PAGE -1;
